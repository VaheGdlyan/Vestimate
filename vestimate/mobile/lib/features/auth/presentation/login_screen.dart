...
import 'package:vestimate/core/router/router.dart';
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // Epic 6 — Dev mode shortcut (only shown when kDevAuthBypass is true)
              if (kDevAuthBypass) ...[
                const SizedBox(height: V.s32),
                const Divider(),
                const SizedBox(height: V.s12),
                Text(
                  'DEV MODE',
                  textAlign: TextAlign.center,
                  style: V.label.copyWith(color: V.warning, letterSpacing: 2),
                ),
                const SizedBox(height: V.s8),
                OutlinedButton.icon(
                  onPressed: () {
                  ...
                  style: OutlinedButton.styleFrom(
                    foregroundColor: V.warning,
                    side: BorderSide(color: V.warning.withOpacity(0.4)),
                  ),
                ),
              ],
            ],
